    ...
    return (
        <div className="space-y-6">
            <div className="p-6 rounded-2xl text-white shadow-lg bg-gradient-to-br from-cyan-400 to-cyan-600">
                ...
                <p className="mt-1 opacity-90">{t('lifestyle.stopwatch.desc')}</p>
            </div>
            ...
            {laps.length > 0 && (
                <div className="p-4 sm:p-6 bg-white border border-gray-100 rounded-3xl shadow-xl space-y-4 animate-in slide-in-from-bottom-4 duration-500">
                    <div className="flex justify-between items-center px-2">
                        <h3 className="text-sm font-black text-gray-400 uppercase tracking-widest">{t('lifestyle.stopwatch.lap_records')}</h3>
                        <span className="text-[10px] sm:text-xs font-bold text-blue-600 bg-blue-50 px-2 py-1 rounded-lg">{t('lifestyle.stopwatch.lap_count', { count: laps.length })}</span>
                    </div>
                                ...
                                <div key={index} className="flex justify-between items-center p-3 sm:p-4 bg-gray-50 rounded-2xl border border-gray-100 group hover:border-blue-200 transition-colors">
                                    <div className="flex items-center space-x-3 sm:space-x-4">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-[8px] sm:text-[10px] font-black text-gray-400 uppercase">{t('lifestyle.stopwatch.total')}</span>
                                        </div>
                                    </div>
