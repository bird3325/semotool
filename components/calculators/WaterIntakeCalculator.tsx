...
const WaterIntakeCalculator: React.FC = () => {
    ...
    const activityLevels = [
        { name: t('health.water_intake.opt_normal'), multiplier: 1 },
        { name: t('health.water_intake.opt_active'), multiplier: 1.2 },
    ];
        ...
        <div className="space-y-6">
            <div className="p-6 rounded-2xl text-white shadow-lg bg-gradient-to-br from-pink-400 to-pink-600">
                <div className="flex items-center space-x-3">
                    <GlassWater size={28} />
                    <h2 className="text-2xl font-bold">{t('tool.water-intake')} {t('suffix.calculator')}</h2>
                </div>
                <p className="mt-1 opacity-90">{t('health.water_intake.desc')}</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md space-y-6">
                ...
                <SelectModal
                    label={t('health.water_intake.activity_multiplier')}
            ...
            {result && (
                <div className="p-6 bg-gray-50 rounded-xl text-center">
                    <p className="text-sm text-gray-500">{t('health.water_intake.result_title')}</p>
